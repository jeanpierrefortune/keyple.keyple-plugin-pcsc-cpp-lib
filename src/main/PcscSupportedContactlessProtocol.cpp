...
const PcscSupportedContactlessProtocol
    PcscSupportedContactlessProtocol::MIFARE_ULTRA_LIGHT(
        "MIFARE_ULTRA_LIGHT", "3B8F8001804F0CA0000003060300030000000068");
const PcscSupportedContactlessProtocol
    PcscSupportedContactlessProtocol::MIFARE_CLASSIC(
        "MIFARE_CLASSIC", "3B8F8001804F0CA000000306030001000000006A");
const PcscSupportedContactlessProtocol
    PcscSupportedContactlessProtocol::MIFARE_DESFIRE(
        "MIFARE_DESFIRE", "3B8180018080");
const PcscSupportedContactlessProtocol
    PcscSupportedContactlessProtocol::MEMORY_ST25(
        "MEMORY_ST25", "3B8F8001804F0CA000000306070007D0020C00B6");

PcscSupportedContactlessProtocol::PcscSupportedContactlessProtocol(
...
const std::string&
PcscSupportedContactlessProtocol::getDefaultRule() const
{
    return mDefaultRule;
}

const std::string&
PcscSupportedContactlessProtocol::getName() const
{
    return mName;
}
